...
ARG VUE_APP_CODA_DASHBOARD_BACKEND_URL=${VUE_APP_CODA_DASHBOARD_BACKEND_URL}
...
ENV VUE_APP_CODA_DASHBOARD_BACKEND_URL=${VUE_APP_CODA_DASHBOARD_BACKEND_URL}
...
RUN echo "VUE_APP_CODA_DASHBOARD_KEYCLOAK_URL=${VUE_APP_CODA_DASHBOARD_KEYCLOAK_URL}\n" > .env
